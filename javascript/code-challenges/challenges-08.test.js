...
// used refer for regex https://www.w3schools.com/jsref/jsref_regexp_wordchar.asp , http://www.roblocher.com/technotes/regexp.html
// https://stackoverflow.com/questions/26791791/unfamiliar-code-snippet-ba-z-g
...
const citiesAtoJ = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    let regexStuff = /^[A-J]/g;
    if (regexStuff.test(arr[i])) {
      array.push(arr[i]);
    }
  }
  return array;
